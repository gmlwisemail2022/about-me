/**********************************************
 * Drawing Wave Functionality
 * ==================================
 * This class extends the PaintFunction class, which you can find in canvas-common
 ***********************************************/
// https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/clearRect

class DrawingWave extends PaintFunction {
   ...
   // to the current mouse position
        ...
        this.contextDraft.bezierCurveTo(this.origX + 150, this.origY + 25, this.origX + 100, this.origY + 200, 
            this.origX + 245, 100, this.origY + 50);
        this.contextDraft.lineTo(coord[0], this.origX + 150);
        this.contextDraft.lineTo(this.origX, this.origX + 150);
        this.contextDraft.closePath();

        /*
            this.contextDraft.moveTo(50, 130);
        this.contextDraft.bezierCurveTo(300, 50, 200, 400, 490, 100);
        this.contextDraft.lineTo(490, 300);
        this.contextDraft.lineTo(50, 300);
        */
